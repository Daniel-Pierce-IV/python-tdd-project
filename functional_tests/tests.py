...
class NewVisitorTest(StaticLiveServerTestCase):
    ...
    def test_can_start_a_list_and_retrieve_it_later(self):
        ...
        # She then sees that the site has generated a unique URL for her
    ...
    def test_multiple_users_can_start_lists_at_different_urls(self):
        ...
        ## We use a new browser session to ensure that none of
        ## Edith's information is carried over
        self.browser.quit()
        self.browser = webdriver.Firefox()

        # Francis visits the webpage.
    ...
    def test_layout_and_styling(self):
        ...
        # She starts a new list and sees
        # the input is nicely formatted there as well
